...
function getOperand(operand) {
	...
	switch (operand) {
		...
		input_var2.value += 'log(';
		break; 
		case 'sqrt': 
		input_var.value += 'Math.sqrt(';
		input_var2.value += '√( ';
		break; 
		case '(':
		input_var.value += '(';
		...
		case 'mod':
		input_var.value += '%';
		input_var2.value += ' Mod ';
		break; 
		case 'pi':
		input_var.value += Math.PI; 
		input_var2.value += 'π'; 
		break; 
		case 'SIN':
		input_var.value += 'Math.sin(';
		input_var2.value += 'sin(';  
		break; 
		case 'COS':
		input_var.value += 'Math.cos('; 
		input_var2.value += 'cos(';  
		break; 
	}
}
